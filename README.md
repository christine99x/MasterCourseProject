...
* Assignment 1: a digit recognition task and an XOR problem. In this task, we learned several dimensionality reduction techniques, implemented a one-layer neural network and a 2x2 neural network.  
